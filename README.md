# MEDP33100 - Class 3 Homework - Todo list 
...
3. In VSCode, complete the JavaScript in `script.js` and make sure your page works
4. Push your updates to your forked repository
5. Enable [GitHub Pages](https://www.notion.so/How-to-enable-Github-Pages-23dda96d871f80c99f2fec87680ccf07?pvs=21)  
   (Note: your main HTML file must be named `index.html`)
6. Create a [Pull request](https://medp33100.notion.site/How-to-create-a-Pull-request-PR-26ada96d871f8026bddfe17cf09fdb15?source=copy_link)